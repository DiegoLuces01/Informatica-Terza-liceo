...
let particula = {
    ...
    move:function(){
        ...
        if(this.x>barrita2.x && this.y>barrita2.y && this.y <barrita2.y + 80)
        {
          console.log("chocó2")
          if(this.vX>0){
              this.vX=-this.vX
          ...
          if(this.x<barrita1.x && this.y>barrita1.y && this.y <barrita1.y + 80){
            console.log("choco1")
            if(this.vX<0){
              this.vX=-this.vX
            }
        ...
        if(score1>20){
          ...
          ctx.font="50px Arial";
          ctx.fillStyle="red";
          ctx.fillText(`JUGADOR 1 GANA`, 80,100);
